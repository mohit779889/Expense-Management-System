        ...
        {loading === true ? (
          ...
          <>
            <div
              className="container containerBox"
              style={{
                position: "relative", zIndex: "2 !important", justifyContent: "center"
              }}
            >
              <div className="avatarBox">
                      ...
                      return (
                        <div key={index} className="col-lg-3 col-md-6 col-6">
                          <img
                            src={image}
                            alt={`Avatar ${index}`}
                            className={`avatar ${selectedAvatar === index ? "selected" : ""} img-avatar mt-5`}
                            onClick={() => setSelectedAvatar(index)}
                            style={{ width: '150px', height: '150px' }} // Corrected style usage here
                          />
                        </div>
                      );
                    })}
